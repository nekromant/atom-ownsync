...
export default class AtomOwnSyncCore {
    ...
    loadSettings(core) {
        ...
        core.dir = atom.config.get("atom-ownsync.tarballPath")
        core.archive = atom.config.get("atom-ownsync.tarballName")
        core.excludes = atom.config.get("atom-ownsync.IgnoredFilesList")
